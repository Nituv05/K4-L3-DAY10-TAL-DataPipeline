...
def main() -> None:
    ...
    source_summary = {
        ...
        "raw_api_response": settings.paths.raw_api_response.relative_to(settings.paths.project_dir).as_posix(),
        "raw_records_json": settings.paths.raw_records_json.relative_to(settings.paths.project_dir).as_posix(),
